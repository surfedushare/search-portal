...
for empty_theme in {"Interdisciplinair"}:
    CUSTOM_THEME_DISCIPLINES[empty_theme] = ["null"]
...
CUSTOM_COPYRIGHTS = {
    ...
    "cc-by-nc": {"external_ids": ["cc-by-nc-30", "cc-by-nc-40"],
                 "title": "Naamsvermelding-NietCommercieel"},
    "cc-by-nc-nd": {"external_ids": ["cc-by-nc-nd-30", "cc-by-nc-nd-40"],
                    "title": "Naamsvermelding-NietCommercieel-GeenAfgeleideWerken"},
    "cc-by-nc-sa": {"external_ids": ["cc-by-nc-sa-30", "cc-by-nc-sa-40"],
                    "title": "Naamsvermelding-NietCommercieel-GelijkDelen"},
