  ...
  <div>
    <div class="header">
      ...
      <editor-menu-bar v-slot="{ commands, isActive }" :editor="editor">
        <div class="menubar">
          <div class="menubar-button bold" :class="{ 'is-active': isActive.bold() }" @click="commands.bold">
            <span>B</span>
          </div>
          <div class="menubar-button italic" :class="{ 'is-active': isActive.italic() }" @click="commands.italic">
            <span>I</span>
          </div>
          <div
          ...
          <div class="menubar-button" :class="{ 'is-active': isActive.link() }" @click="openLinkPopup">
            <span>
              <i class="fas fa-link" />
            </span>
          </div>
    ...
    <Popup v-if="showLinkPopup" :is-show="showLinkPopup" :close="closeLinkPopup" class="popup-content">
      <slot>
...
export default {
  ...
  methods: {
    ...
    openLinkPopup() {
      ...
      const selectedNode = this.editor.view.docView.node.resolve(selectionPos.from, selectionPos.to).nodeAfter;
      this.url = selectedNode.marks[0] ? selectedNode.marks[0].attrs.href || "" : "";
