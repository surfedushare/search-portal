...
class TestGetHarvestSeedsEdurep(TestCase):
    ...
    def test_get_complete_set(self):
        seeds = get_harvest_seeds(Repositories.EDUREP, "surfsharekit", make_aware(datetime(year=1970, month=1, day=1)))
    ...
    def test_get_partial_set_without_deletes(self):
        seeds = get_harvest_seeds(Repositories.EDUREP, "surfsharekit", make_aware(
