...
class TestSyncSharekitMetadata(TestCase):
    ...
    def setUp(self):
        ...
        SharekitMetadataHarvestFactory.create(is_initial=False, number=0, is_extracted=True)
        SharekitMetadataHarvestFactory.create(is_initial=False, number=1)
    ...
    def test_sync_sharekit_metadata(self):
        ...
        for collection in Collection.objects.filter(name="edusources", dataset_version__version="0.0.2",
            ...
            delete_doc = collection.documents.get(properties__external_id="63903863-6c93-4bda-b850-277f3c9ec00e")
