...
class AnatomyToolOAIPMHFactory(factory.django.DjangoModelFactory):
    ...
    def body(self):
        ...
        response_file = f"anatomy-tool-oaipmh.{response_type}.{self.number}.xml"
        response_file_path = os.path.join(settings.BASE_DIR, "anatomy_tool", "fixtures", response_file)
