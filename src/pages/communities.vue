    ...
    <section class="communities">
      <div class="center_block center-header communities__center-header">
        <div class="communities__info ">
          ...
          />
          <h2 class="communities__info_ttl">{{ (!userCommunities) ? $t('Communities') : $t('My-communities') }}</h2>
        </div>
      </div>
      <div class="center_block">
        <ul class="communities__items" v-if="communities.length">
          ...
          >
            ...
            <router-link
              :to="localePath({name: (userCommunities) ? 'my-community' : 'communities-community', params: {community: community.id}})"
        ...
        <h3 class="text-center" v-else-if="userCommunities" v-html="$t('html-No-communities-available-logged-in')"></h3>
