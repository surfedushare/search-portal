from surf.apps.materials.views.app import portal_material, portal_single_page_application, portal_page_not_found
from surf.apps.materials.views.search import MaterialSearchAPIView, KeywordsAPIView, MaterialAPIView, MaterialSetAPIView
