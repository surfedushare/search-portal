...
class TestSitemaps(TestCase):
    ...
    def test_index(self, request_get):
        ...
        expected_locations = [
            "https://edusources.nl/sitemap-main.xml",
            "https://edusources.nl/sitemap-materials.xml",
            "https://edusources.nl/sitemap-materials.xml?p=2",
        ]
        ...
        for location in actual_locations:
            relative_url = location.replace("https://edusources.nl", "")
    ...
    def test_materials_sitemap(self, request_get):
        ...
        soup = BeautifulSoup(response.content, "html5lib")
        expected_locations = [
            "https://edusources.nl/materialen/external-id:1",
            "https://edusources.nl/en/materials/external-id.2",
            "https://edusources.nl/materialen/external-id%2F3",
        ]
    ...
    def test_main_sitemap(self, request_get):
        ...
        expected_locations = [
            "https://edusources.nl/",
            "https://edusources.nl/hoe-werkt-het",
            "https://edusources.nl/en",
            "https://edusources.nl/en/how-does-it-work",
        ]
