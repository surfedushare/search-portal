...
class TestSearchFiltering(BaseLiveServerTestCase):
    ...
    def test_pre_filter_search(self):
        ...
        self.selenium.find_element_by_xpath('//div[@data-test="filter_technical_type"]').click()

        self.selenium.find_element_by_xpath('//input[@data-test="filter_technical_type_video"]').click()
        self.selenium.find_element_by_css_selector(".search_bar input[type=search]").send_keys("Wiskunde")

        self.selenium.find_element_by_css_selector(".search_bar button").click()
