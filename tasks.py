...
aws_collection = Collection("aws", build, push, migrate, promote, print_available_images, sync_repository_state,
                            publish_runner_image, cleanup_ecs_artifacts, publish_tika_image)
